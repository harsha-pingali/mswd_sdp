          ...
          <Grid container spacing={4}>
            ...
            >
                ...
                <CardActions sx={{ justifyContent: 'flex-end', padding: '16px' }}>
                    <Button size="small" variant='contained' sx={{ backgroundColor: '#87CEEB', color: '#FFF', '&:hover': { backgroundColor: '#4CAF50', boxShadow: 'none' } }}  onClick={() => handleCart(item.id)}  ><ShoppingCartIcon/>Add To cart</Button>
